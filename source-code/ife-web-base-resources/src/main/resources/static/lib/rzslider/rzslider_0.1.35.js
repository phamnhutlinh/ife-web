...
(function (root, factory) {
  ...
  'use strict';
var module = angular.module('rzModule', ['filterUIModule'])
...
.factory('RzSlider', function($timeout, $document, $window, throttle, $filter)
{
  'use strict';
  ...
  Slider.prototype = {
    ...
    positionTrackingHandle: function(newValue, newOffset)
    {
      ...
      //Fixed new value > max value
      if(this.scope[this.tracking] !== newValue && newValue <= this.maxValue)
      {
