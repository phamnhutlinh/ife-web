...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            ...
            //nextButtonText : '<i class="fa fa-step-forward" id="nextButtonTextIcon"></i>',
            //nextButton : '<button class="btn btn-primary btn-xs bootstro-next-btn">Next &raquo;</button>',
            prevButtonText : '&laquo; Prev',
            //prevButtonText : '<i class="fa fa-step-backward" id="prevButtonTextIcon"></i>',
        ...
        function add_nav_btn(content, i)
        {
            ...
            if (bootstrapVersion == 2)
            	...
            	defaultBtnClass = "btn v3-btn-primary v3-portal-userguide-button"; //default bootstrap version 3
            	defaultBtnFinishClass = "btn v3-btn-primary v3-portal-userguide-button";
            }                
            	 //defaultBtnClass = "btn btn btn-lg"; //default bootstrap version 3
            ...
            {
                finishButton = '<button class="' + defaultBtnFinishClass +' bootstro-finish-btn">' + $el.attr('data-bootstro-finishButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.finishButton != 'undefined' /*&& settings.finishButton != ''*/)
                    ...
                    finishButton = '<button class="' + defaultBtnFinishClass +' bootstro-finish-btn">' + settings.finishButtonText + '</button>';
            }
        ...
        get_popup = function(i)
        {
            ...
            if ($el.attr('data-bootstro-position'))
            {
                p.position = $el.attr('data-bootstro-position');
                style = style + 'position:' + $el.attr('data-bootstro-position') + ';'
            }
            ...
            p.template = '<div class="popover v3-popover-user-guide" onClick="check_element(event)" style="' + style + '"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div>' +
             '</div>';
        ...
        bootstro.go_to = function(idx) 
        {
            ...
            if (count != 0)
            {
                ...
                if (topDistance < settings.margin){ //the element too up above
                	if($el[0].getAttribute('id') == "headerLanguage"){
                		$('html,body').animate({
	                        scrollTop: 0},
	                    'slow');
                	}else{
